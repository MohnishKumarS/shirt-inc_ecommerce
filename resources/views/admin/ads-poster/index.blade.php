      ...
      <div>
          ...
          @foreach ($poster as $val)
              <tr  class="align-middle text-center">
                  <td>{{$i++}}</td>
                  <td>
                      <img src="{{asset('image/Ads-poster/'.$val->image)}}" width="400" height='200' style="object-fit: contain" alt="ads-poster">
                  </td>
                  <td>{{$val->title}}</td>
                  <td>{{$val->desc}}</td>
                  <td>
                  ...
                  <td>
                      ...
                      <a href="{{ url('delete-poster/'.$val->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure to delete it');">Delete</a>
                  </td>
              </tr>
          @endforeach
          </table>
