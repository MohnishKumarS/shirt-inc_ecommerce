            ...
            <form action="/update-category/{{ $data->id }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div>
                            @if ($data->icon)
                                <img src="{{ asset('image/category/icons/' . $data->icon) }}" alt="category-icon"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div>
                            <img src="{{ asset('image/category/' . $data->image) }}" alt="category-image" width="200"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div>
                            @if ($data->poster)
                                <img src="{{ asset('image/category/poster/' . $data->poster) }}" alt="category-poster"
                                    class="img-fluid" height="130" style="object-fit: contain">
                            @else
                                <div class="text-danger">
                            ...
                            <td>
                                @if ($val->image != '')
                                    <img src="{{ asset('/image/product/' . $img[0]) }}" alt="product-image"
                                        width="120" height="150" style="object-fit: contain">
                                @else
                                    <img src="{{ asset('/image/product/design/' . $val->design) }}" alt="product-design"
                                        width="120" height="150" style="object-fit: contain">
                                @endif
                            </td>
                            <td>{{ $val->name }}</td>
