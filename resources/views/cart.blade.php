        ...
        <div class="card-body">
            ...
            <div class="" style="padding: 60px 0">
                <div class="text-center">
                    <img src="{{asset('image/empty/cart-empty.png')}}" alt="cart-empty" class="img-fluid" loading="lazy">
                    <h3>Your Cart is <span class="title-hlorg"> Empty!</span></h3>
                    <p class="text-sm text-normal">Look like you have not added anything to you cart. Go ahead & explore
                        top Collections... </p>
                    <div class="mt-4">
                ...
                <div class="row px-5">
                    ...
                    <div class="col">
                        <div class="cart-address text-center">
                            <div class="icon-image">
                                <img src="https://img.icons8.com/clouds/100/address.png" alt="address" loading="lazy"/>
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 ">
                                    <div class="cart-img">
                                        <img src="{{ asset('image/product/' . $img[0]) }}" alt="cart-product" class="img-fluid" loading="lazy"`>
                                    </div>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-9 mt-2 mt-sm-0 text-c">
                                    <div class="cart-details">

                                        <h5 class=""><a class="title-hover" href="{{ url('category/'.$category[$i]->slug.'/'.$val->product->slug) }}">{{ $val->product->name }}</a></h5>
                                        <h6><a href="{{ url('category/'.$category[$i]->slug) }}" class="text-sm title-hover1">{{$category[$i]->name}}</a></h6>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-5 col-sm-6 col-6">
                                                ...
                                                <div>
                                                    ...
                                                    $men_size = $val->product->couple_men_size ?
                                                    json_decode($val->product->couple_men_size) : '';
                                                    $women_size = $val->product->couple_women_size ?
                                                    json_decode($val->product->couple_women_size) : '';
                                                    // print_r($men_size);
                                                    ...
                                                    <div class="row">
                                                        <div class=" col-6">
                                                            <select class="form-select men_size" required>
                                                                <option selected value="">Select Men's size
                                                                </option>
                                                        ...
                                                        <div class="col-6">
                                                            <select class="form-select women_size" required>
                                                                <option selected value="">Select Women's size
                                                                </option>
                                                                {{-- ---- size get in database --- --}}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-select com_size" required>
                                                                <option selected value="">Choose your size
                                                                </option>
                                                                {{-- ---- size get in database --- --}}
                                            ...
                                            <div class="col-lg-4 col-md-3 col-sm-4 col-5 ">
                                                <div class="">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            <label for="" class="text-sm">Quantity <span
                                                                    class="text-danger">*</span></label>
                                                            <div class="input-group">

                                                                <span class="input-group-text decrement-btn change_Qty"
                                                                    style="cursor: pointer">-</span>
                                                                <input type="text"
                                                                    class="form-control qty-value text-center"
                                                                    name="quantity" value="{{ $val->product_qty }}">
                                                                <span class="input-group-text increment-btn change_Qty"
                                                                    style="cursor: pointer">+</span>
                                                            </div>
                                                        </div>
                                                        @php
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <label for="" class="text-danger ms-2 text-sm">
                                                @if ($val->product->quantity <= 5 && $val->product->quantity >= 1)
                                                    Hurry up! only {{ $val->product->quantity }} items left...
                                                    @endif
                                            </label>
                ...
                <div class="col-lg-4 mt-4 mt-lg-0">
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <div class="my-3">
                                <a href="javascript:void(0)" class="btn-blue w-100 checkout-event">Proceed to
                                    Checkout</a>
                            </div>
