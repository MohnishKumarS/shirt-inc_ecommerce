...
<div>
  ...
  <section class="container mw-930 lh-30 policies">
    <h2 class="section-title text-uppercase fw-bold mb-4">Privacy Policy</h2>
    <p class="mb-2">
      At Shirt Inc, accessible from <a class="menu-link_us-s" href="https://shirt-inc.com/">https://shirt-inc.com/</a>, one of our main priorities is the privacy of our
      visitors. This Privacy Policy document contains types of information that is collected and recorded by
      Shirt Inc and how we use it.
    </p>
    <p class="mb-2">If you have additional questions or require more information about our Privacy Policy, do not hesitate to
      contact us.</p>

  <p class="mb-4 pb-3">This Privacy Policy applies only to our online activities and is valid for visitors to our website with
      regards to the information that they shared and/or collect in Shirt Inc. This policy is not applicable
      to any information collected offline or via channels other than this website.</p>


    <h6 class="mb-1">Consent</h6>
    <p class="mb-4 pb-3">
      By using our website, you hereby consent to our Privacy Policy and agree to its terms.
    </p>
    <h6 class="mb-1">Information we collect</h6>
    <p class="mb-2">The personal information that you are asked to provide, and the reasons why you are asked to provide it,
      will be made clear to you at the point we ask you to provide your personal information.</p>

  <p class="mb-2">If you contact us directly, we may receive additional information about you such as your name, email
  ...
  <p class="mb-4 pb-3">When you register for an Account, we may ask for your contact information, including items such as name,
    ...
    <p class="mb-4 pb-3">Shirt Inc follows a standard procedure of using log files. These files log visitors when they visit
    ...
    <h6 class="mb-1">Cookies and Web Beacons</h6>
    <p class="mb-4 pb-3">
      Like any other website, Shirt Inc uses "cookies". These cookies are used to store information including
    ...
    <h6 class="mb-1">Google DoubleClick DART Cookie</h6>
    <p class="mb-4">Google is one of a third-party vendor on our site. It also uses cookies, known as DART cookies, to serve
      ...
      network Privacy Policy at the following URL – <a class="menu-link_us-s" href="https://policies.google.com/technologies/ads">https://policies.google.com/technologies/ads</a></p>
    <h6 class="mb-1">Our Advertising Partners</h6>
    <p class="mb-4 pb-3">
    ...
    <p class="mb-4 pb-3">
        <a class="menu-link_us-s" href="
            https://policies.google.com/technologies/ads" >
            https://policies.google.com/technologies/ads</a>
    </p>

    <h6 class="mb-1">Advertising Partners Privacy Policies</h6>

    <p class="mb-2">You may consult this list to find the Privacy Policy for each of the advertising partners of Shirt Inc.
    </p>

    <p class="mb-2">Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
        used in their respective advertisements and links that appear on Shirt Inc, which are sent directly to
    ...
    <p class="mb-4 pb-3"><b>Note : Shirt Inc has no access to or control over these cookies that are used by third-party
            advertisers.</b></p>

    <h6 class="mb-1">
        Third Party Privacy Policies</h6>

    <p class="mb-2">Shirt Inc's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
    ...
    <h6 class="mb-1">CCPA Privacy Rights (Do Not Sell My Personal Information)</h6>

    <div>
        <ul>
           <p class="mb-4 pb-3"> Under the CCPA, among other rights, California consumers have the right to:</p>
            ...
            <li>If you make a request, we have one month to respond to you. If you would like to exercise any of
                these rights, please contact us.</li>
        </ul>
    </div>

    <h6 class="mb-1">GDPR Data Protection Rights</h6>
    <div>
        <ul>
            <p class="mb-4 pb-3">We would like to make sure you are fully aware of all of your data protection rights. Every user is
            ...
            <li><b>If you make a request, we have one month to respond to you. If you would like to exercise any
                    of these rights, please contact us.</b></li>
        </ul>
    </div>

    <h6 class="mb-1">Children's Information</h6>

    <p class="mb-2">Another part of our priority is adding protection for children while using the internet. We encourage
        parents and guardians to observe, participate in, and/or monitor and guide their online activity.</p>

    <p class="mb-4 pb-3">Shirt Inc does not knowingly collect any Personal Identifiable Information from children under the age of
    ...
    <h6 class="mb-1">Changes to This Privacy Policy</h6>

    <p class="mb-2">We may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically
    ...
    <p class="mb-4 pb-3">Our Privacy Policy was created with the help of the Privacy Policy Generator.</p>

    <h6 class="mb-1">Contact Us</h6>

    <p class="mb-4 pb-3">If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.</p>
