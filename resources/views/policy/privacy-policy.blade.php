...
<section class="product-terms">
    <div class="container">
        <div class="row">
            ...
            <h2 class="mb-4"> Privacy Policy for Shirt INC </h2>
        ...
        <div class="term-contents">
            ...
            <p>Shirt Inc follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Shirt Inc uses "cookies". These cookies are used to store information including
            ...
            <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Shirt Inc.
            </p>
            ...
            <p><b>Note : Shirt Inc has no access to or control over these cookies that are used by third-party
                    advertisers.</b></p>

            <h5>
                Third Party Privacy Policies</h5>

            <p>Shirt Inc's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
            ...
            <p>Shirt Inc does not knowingly collect any Personal Identifiable Information from children under the age of
