                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="text-center text-lg-start mt-3 mt-lg-0">
                                        <h5 class=""><a class="title-hover" href="{{ url('category/'.$cat[$i]->slug.'/'.$val->product->slug) }}">{{ $val->product->name }}</a></h5>
                                        <h6><a href="{{ url('category/'.$cat[$i]->slug) }}" class="text-sm title-hover1">{{$cat[$i]->name}}</a></h6>
                                        ...
                                        <div class="mt-4">
                                            <button class="btn-glow addToCart" ><i class="bi bi-cart-fill me-2"></i>Add to Cart</button>
