        ...
        <div class="container py-5">
            ...
            @if ($category[0]->poster != null)
                <div class="poster-img mb-4">
                    <img src="{{ asset('image/category/' . $category[0]->poster) }}" alt="poster" class="img-fluid"
                        loading="lazy">
                </div>
            @endif
            ...
            <div class="product-view container p-0">
                <div class="row ">
                                                            ...
                                                            @if (count($img) > 1)
                                                                <a class="image">
                                                                    <img src="{{ asset('image/product/' . $img[0]) }}"
                                                                        class="pic-1 rotate" alt="product-tshirt"
                                                                        loading="lazy">
                                                                    <img src="{{ asset('image/product/' . $img[1]) }}"
                                                                        class="pic-2 rotate" alt="product-tshirt"
                                                                        loading="lazy">
                                                                </a>
                                                            @else
                                                                <a class="image">
                                                                    <img src="{{ asset('image/product/' . $val->image) }}"
                                                                        class="pic-1" alt="product-tshirt"
                                                                        loading="lazy">
                                                                </a>
                                                            @endif
