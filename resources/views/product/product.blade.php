    ...
    @if ($category->poster)
        <section class="full-width_padding">
            <div class="top_banners">
                <img src="{{ asset('image/category/poster/' . $category->poster) }}" alt="{{ $category->slug }}" loading="lazy"
                    class="w-100">
            </div>
        </section>
    @endif
                                            ...
                                            <div class="swiper-container background-img js-swiper-slider"
                                                ...
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <a
                                                            href="{{ url('category/' . $val->category->slug . '/' . $val->slug) }}">
                                                            @if ($val->image != '')
                                                                @if (count($img) > 1)
                                                                    <img loading="lazy"
                                                                        src="{{ asset('image/product/' . $img[0]) }}"
                                                                        width="330" height="400"
                                                                        alt="{{ $val->slug }}" class="pc__img">
                                                                    <img loading="lazy"
                                                                        src="{{ asset('image/product/' . $img[1]) }}"
                                                                        width="330" height="400"
                                                                        alt="{{ $val->slug }}"
                                        ...
                                        <div
                                            ...
                                            @if ($val->offer_menu)
                                                <div class="pc-labels__left">
                                                    <span
                                                        class="pc-label pc-label_new d-block bg-white">{{ $val->offer_msg }}</span>
                                                </div>
                                            @endif

                                            <div class="pc-labels__right">
                                                <span
                                                    class="pc-label pc-label_sale d-block text-white">-{{ $dis_count }}%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
