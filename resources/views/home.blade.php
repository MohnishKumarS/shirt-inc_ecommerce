...
@section('content')
  ...
  <div class="container">
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
          ...
          <div class="position-relative" id="categorySection">
              ...
              <div class="products-carousel__prev products-carousel__prev position-absolute top-50 d-flex align-items-center justify-content-center">
                   <img src="{{ asset("assets/icons/icon_left_chevron.svg") }}" alt="cart Icon">
              </div>
              <div class="products-carousel__next products-carousel__next position-absolute top-50 d-flex align-items-center justify-content-center">
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      <div class="mb-3 mb-xl-5 pt-1 pb-4"></div>
      <section class="category-carousel container" >
          <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">THEMES ART</h2>
