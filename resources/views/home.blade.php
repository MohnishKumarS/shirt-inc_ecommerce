    ...
    <section class="category-masonry container">
        <div class="row">
            <div class="col-lg-6 px-4">
                ...
                <div class="category-masonry__item">
                    <div class="category-masonry__item-image pb-1 mb-4">
                        <img loading="lazy" class="h-auto" src="{{asset('image/sample/ghost.png')}}"
                            width="570" height="500" alt="">
                    </div>
                ...
                <div class="category-masonry__item">
                    <div class="category-masonry__item-image pb-1 mb-4">
                        <img loading="lazy" class="h-auto" src="{{asset('image/sample/fuck.png')}}"
                            width="672" height="480" alt="">
                    </div>
            ...
            <div class="col-lg-6 px-4 d-lg-flex flex-lg-column align-items-lg-end">
                <div class="category-masonry__item">
                    <div class="category-masonry__item-image pb-1 mb-4">
                        <img loading="lazy" class="h-auto" src="{{asset('image/sample/samosa.png')}}"
                            width="570" height="631" alt="">
                    </div>
                    <h2>Men’s Spring Collection 2020</h2>
                    <a href="{{ url('womens-collections') }}"
                ...
                <div class="category-masonry__item">
                    <div class="category-masonry__item-image pb-1 mb-4">
                        <img loading="lazy" class="h-auto" src="{{asset('image/sample/tea.png')}}"
                            width="450" height="550" alt="">
                    </div>
                    <h2>Fresh Dresses</h2>
                    <a href="{{ url('mens-collections') }}"
