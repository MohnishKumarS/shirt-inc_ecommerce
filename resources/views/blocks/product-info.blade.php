        ...
        <div class="col-lg-5">
            ...
            <div class="product-single__rating">
                <div class="reviews-group d-flex">
                      <img src="{{ asset("assets/icons/icon_star.svg") }}" alt="cart Icon"> 
                      <img src="{{ asset("assets/icons/icon_star.svg") }}" alt="cart Icon"> 
                      <img src="{{ asset("assets/icons/icon_star.svg") }}" alt="cart Icon"> 
                      <img src="{{ asset("assets/icons/icon_star.svg") }}" alt="cart Icon"> 
                </div>
            ...
            <div class="product-single__addtolinks">
                <a href="#" class="menu-link menu-link_us-s add-to-wishlist">
                    <img src="{{ asset("assets/icons/icon_heart.svg") }}" alt="cart Icon">
                    <span>Add to Wishlist</span>
                </a>
                <share-button class="share-button">
                    <button class="menu-link menu-link_us-s to-share border-0 bg-transparent d-flex align-items-center">
                        <img src="{{ asset("assets/icons/icon_share.svg") }}" alt="cart Icon">
                        <span>Share</span>
                    </button>
